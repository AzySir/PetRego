...
public interface PetRepository extends JpaRepository<Pet, Long> {
        ...
        @Query(value = "SELECT ID, PET_NAME, TYPE, FOOD FROM PETS WHERE PET_NAME = ?1", nativeQuery = true)
        ...
        @Query(value = "SELECT ID, PET_NAME, TYPE, FOOD FROM PETS WHERE OWNER_ID = ?1", nativeQuery = true)
